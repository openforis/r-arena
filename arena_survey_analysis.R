    ...
    if (exists("result_names_category_2")) rm(result_names_category_2) 
     ...
     cat_names_num <- result_cat[[ arena.analyze$entity ]] %>%
      ...
      # https://cran.r-project.org/web/packages/srvyr/vignettes/srvyr-vs-survey.html
        ...
        out_file <- list()
        out_file[[1]] <- paste0(user_file_path, "out_mean.csv")
        out_file[[2]] <- paste0(user_file_path, "out_total.csv")
        out_file[[3]] <- paste0(user_file_path, "out_global_total.csv")
        out_file[[4]] <- paste0(user_file_path, "relative_efficiency.csv")
        out_file[[5]] <- paste0(user_file_path, "nonresponse_correction_by_stratum.csv")
